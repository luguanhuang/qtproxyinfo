...
#if 1
#define logError(clog, fmt) \
do \
{ \
    clog.write(CLOG_ERROR, __FILE__, __FUNCTION__, __LINE__, fmt); \
} while (0)


#define logDebug(clog, fmt) \
do \
{ \
    clog.write(CLOG_DEBUG, __FILE__, __FUNCTION__, __LINE__, fmt); \
} while (0)
#endif
