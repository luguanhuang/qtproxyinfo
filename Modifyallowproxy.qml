...
//            console.log("confirm comment="+comment.text)
           var resinfo = "修改允许代理的进程为";
           resinfo += allocproxy.text;
           resinfo += "完成,共计选中1,";
           var res = operProxy.chgDeadline(proxyid, allocproxy.text)
           resinfo += res;
...
//           operProxy.updateProxyConf(proxyid, textArea.text)
     ...
     Component.onCompleted:
     {
        ...
        textArea.text = "请输入允许的代理进程";
         allocproxy.text = "ALLNAME;ALLMD5;"
